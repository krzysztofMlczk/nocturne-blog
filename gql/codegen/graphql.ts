...
export type Post = Node & {
  ...
  /** A fragment of the post content that encourages to read the whole post */
  excerpt: Scalars['String'];
  /** Image that advertises the blog post */
  featuredImage: Asset;
...
export type PostContentRichTextEmbeddedTypes = Asset | Author | Post | Tag;
...
export type ScheduledOperationAffectedDocument = Asset | Author | Post | Tag;
...
/** Tags for grouping blog posts by topic */
...
export type GetAllPostsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', slug: string, title: string, excerpt: string, createdAt: any, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', name: string } | null }> };

export type GetAllTagsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllTagsQuery = { __typename?: 'Query', tags: Array<{ __typename?: 'Tag', name: string, slug: string }> };

export type GetFeaturedPostsForLandingQueryVariables = Exact<{ [key: string]: never; }>;


export type GetFeaturedPostsForLandingQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, excerpt: string, slug: string, tags: Array<{ __typename?: 'Tag', name: string }> }> };
...
export type GetPostHeadInfoBySlugQuery = { __typename?: 'Query', post?: { __typename?: 'Post', title: string, createdAt: any, author?: { __typename?: 'Author', name: string } | null } | null };
...
export type GetPostsByTagSlugQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', slug: string, title: string, excerpt: string, createdAt: any, featuredImage: { __typename?: 'Asset', url: string }, author?: { __typename?: 'Author', name: string } | null }> };
...
export const GetFeaturedPostsForLandingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetFeaturedPostsForLanding"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"posts"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"where"},"value":{"kind":"ObjectValue","fields":[{"kind":"ObjectField","name":{"kind":"Name","value":"featuredPost"},"value":{"kind":"BooleanValue","value":true}}]}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"tags"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"name"}}]}},{"kind":"Field","name":{"kind":"Name","value":"title"}},{"kind":"Field","name":{"kind":"Name","value":"excerpt"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}}]}}]}}]} as unknown as DocumentNode<GetFeaturedPostsForLandingQuery, GetFeaturedPostsForLandingQueryVariables>;
