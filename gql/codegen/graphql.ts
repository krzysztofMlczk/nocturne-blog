...
export type AssetsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', title: string, slug: string, id: string, excerpt: string, featuredImage: { __typename?: 'Asset', url: string } }> };
